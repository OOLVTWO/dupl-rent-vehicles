...
export const DEFAULT_PAYMENT_METHODS = [
  { id: 'cash', label: 'Cash', icon: 'fa-solid fa-money-bill-wave', color: '#22C55E', active: true },
  ...
  { id: 'qris', label: 'QRIS', icon: 'fa-solid fa-qrcode', color: '#8B5CF6', active: true },
  { id: 'card', label: 'Card (EDC)', icon: 'fa-solid fa-credit-card', color: '#F59E0B', active: true },
...
export function getPaymentMethodMeta(id) {
  ...
  if (id === 'cash') return { id: 'cash', label: 'Cash', icon: 'fa-solid fa-money-bill-wave', color: '#22C55E' };
  if (id === 'transfer') return { id: 'transfer', label: 'Transfer', icon: 'fa-solid fa-building-columns', color: '#3B82F6' };
  if (id === 'qris') return { id: 'qris', label: 'QRIS', icon: 'fa-solid fa-qrcode', color: '#8B5CF6' };
  if (id === 'card') return { id: 'card', label: 'Card (EDC)', icon: 'fa-solid fa-credit-card', color: '#F59E0B' };
